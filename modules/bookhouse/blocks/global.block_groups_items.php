...
if (! nv_function_exists('nv_block_groups_items')) {
    ...
    function nv_block_groups_items($block_config)
    {
        ...
        if (false) {
            ...
            $db->sqlreset()
                ->select('t1.id, catid, title, alias, homeimgfile, homeimgalt, homeimgthumb, price, price_time, money_unit, provinceid, districtid, wardid, phong_ngu, phong_tam, area, way_id ')
		...
		$xtpl->assign('module_link', $module_url);
