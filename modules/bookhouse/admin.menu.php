...
$allow_func = array(
    'main',
    'items',
    'items-import', // VujiTech
    'alias',
    'customers', // VujiTech
    'transactions', // VujiTech
    'getitemid',
    'images',
    'queue',
    'projects',
    'projects-content',
    'projects-import', // VujiTech
    'reason',
    'type',
    'furniture',
    'convenient',
...
if ($NV_IS_ADMIN_MODULE) {
    ...
    $submenu['items-import'] = 'Nhập danh sách BĐS'; // VujiTech
    ...
    $submenu['customers'] = 'Quản lý khách hàng'; // VujiTech
    $submenu['transactions'] = 'Quản lý giao dịch'; // VujiTech
