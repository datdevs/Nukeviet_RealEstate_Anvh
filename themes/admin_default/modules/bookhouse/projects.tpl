...
<form class="form-inline m-bottom">
    ...
    <a class="btn btn-primary" href="{LINK_IMPORT}"><i class="fa fa-file-excel-o" style="margin-right:10px"></i>Import danh sách dự án</a>
</form>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{VIEW.title}</td>
					<td>23</td>
					<td>T2/A03-01, T2/A03-02, T2/A03-03 [Xem Thêm]</td>
